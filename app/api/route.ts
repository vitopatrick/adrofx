                                  ...
                                  <p style="font-size: 14px; line-height: 170%">
                                    <span
                                      style="
                                        ...
                                        line-height: 27.2px;
                                      "
                                      >Thank you for trusting in Adrofx</span
                                    >
                                  </p>
                                </div>
                              </td>
                              ...
                              >
                                ...
                                >
                                  <p style="line-height: 170%">
                                    Welcome to AdroFx We're thrilled to have you
                                    with us.
                                  </p>
                                  <p style="line-height: 170%">
                                    At Adrofx we're committed to your trading
                                    success. Here's what to expect:
                                  </p>
                                  <ol style="list-style-type: none">
                                    <li style="line-height: 23.8px">
                                      <p style="line-height: 170%">
                                        <strong>Diverse Products:</strong>
                                        Explore a range of trading options.
                                      </p>
                                    </li>
                                    <li style="line-height: 23.8px">
                                      <p style="line-height: 170%">
                                        <strong>Cutting-Edge Tech:</strong> Our
                                        platform offers real-time data and
                                        advanced features.
                                      </p>
                                    </li>
                                    <li style="line-height: 23.8px">
                                      <p style="line-height: 170%">
                                        <strong
                                          >Support &amp; Education:</strong
                                        >
                                        We're here 24/7 to assist you, and our
                                        resources help you stay informed.
                                      </p>
                                    </li>
                                  </ol>
                                  <p style="line-height: 170%">
